...
namespace UniversityACS.API.Migrations
{
    ...
    [Migration("20240622143032_chat3")]
    partial class chat3
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UniversityACS.Core.Entities.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "3ffb0f7d-f0e8-42a6-addf-16e03b1d342e",
                            Email = "admin@gmail.com",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            NormalizedEmail = "ADMIN@GMAIL.COM",
                            NormalizedUserName = "ADMIN",
                            PasswordHash = "AQAAAAIAAYagAAAAEN2huz7rj6ms1etoHeJQL+0ON46HeoLtYMhXKC70j8GmiwtzURHB58OowkyIyO/TKQ==",
            ...
            modelBuilder.Entity("UniversityACS.Core.Entities.ChatMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("UniversityACS.Core.Entities.Discipline", b =>
                {
                    ...
                    b.Property<string>("AuditoryTasks")
                        .HasColumnType("text");
                    ...
                    b.Property<int?>("IndependentHours")
                        .HasColumnType("integer");

                    b.Property<int?>("LaboratoryHours")
                        .HasColumnType("integer");

                    b.Property<int?>("LecturerHours")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("UniversityACS.Core.Entities.ChatMessage", b =>
                {
                    b.HasOne("UniversityACS.Core.Entities.ApplicationUser", "Receiver")
                        .WithMany()
                        .HasForeignKey("ReceiverId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("UniversityACS.Core.Entities.ApplicationUser", "Sender")
                        .WithMany()
